...
use crate::utils::{DataHelper, ResponseBuilder};
...
impl WorkoutSessionController {
            ...
            .await
        {
            ...
            Err(e) => {
                ...
                Ok(ResponseBuilder::internal_server_error(
                    "Failed to retrieve workout sessions",
                ))
            }
        }
    }
    ...
    pub async fn create_workout_session(
        ...
        match self
            .workout_session_service
            .create_workout_session(&session_data, auth_context)
            .await
        {
    ...
    pub async fn update_workout_session(
        ...
        match self
            .workout_session_service
            .update_workout_session(&session_data, auth_context)
            .await
        {
            Ok(session) => Ok(ResponseBuilder::success(session)),
            Err(e) => {
    ...
    pub async fn delete_workout_session(
        ...
        match self
            ...
            .await
        {
            Ok(_) => Ok(ResponseBuilder::success(
                json!({"message": "Workout session deleted successfully"}),
            )),
            Err(e) => {
